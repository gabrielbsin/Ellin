...
function enter(pi) {
	...
	var eim = pi.getEventInstance();
        ...
        if(eim.getProperty("spawnedBoss") == null) {
            ...
            if(chests == 0) boss = Packages.server.life.MapleLifeFactory.getMonster(9300119);        //lord pirate
            else if(chests == 1) boss = Packages.server.life.MapleLifeFactory.getMonster(9300105);   //angry lord pirate
            else boss = Packages.server.life.MapleLifeFactory.getMonster(9300106);                   //enraged lord pirate
